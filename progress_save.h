...
bool log_is_empty(const string& file_name) {
...
Player load() {
	...
	// trader
	player.item_updrade_cost = root["Trader"]["cost"].asInt();
	...
	// upgrades
	player.weapon_upgrade_k = root["Player"]["Items"]["weapon_upgrade"].asFloat();

	player.helmet_upgrade_k = root["Player"]["Items"]["helmet_upgrade"].asFloat();
	player.chestplate_upgrade_k = root["Player"]["Items"]["chestplate_upgrade"].asFloat();
	player.leggings_upgrade_k = root["Player"]["Items"]["leggings_upgrade"].asFloat();
	player.boots_upgrade_k = root["Player"]["Items"]["boots_upgrade"].asFloat();
...
bool save(Player& player) {
	...
	// upgrades
	root["Player"]["Items"]["weapon_upgrade"] = player.weapon_upgrade_k;

	root["Player"]["Items"]["helmet_upgrade"] = player.helmet_upgrade_k;
	root["Player"]["Items"]["chestplate_upgrade"] = player.chestplate_upgrade_k;
	root["Player"]["Items"]["leggings_upgrade"] = player.leggings_upgrade_k;
	root["Player"]["Items"]["boots_upgrade"] = player.boots_upgrade_k;
